        ...
        <div id="add-word" style="margin-top:50px;" class="mainbox col-md-6">                    
            <div class="panel panel-info" >
                ...
                <div style="padding-top:30px" class="panel-body" >
                    <form id="add-term-form" class="form-horizontal" role="form" method="post">

                        <div class="row">
                          <div class="col-lg-10">
                            <div class="input-group">
                              <span class="input-group-addon" id="dropdown-symbol">@</span>
                              <input type="text" class="form-control" name="track-term">
              ...
              <div class="col-sm-12 controls">
                  <button id="btn-add" class="btn btn-primary pull-right" type="submit">Add</a>
                  </div>
              </form>   
          </div><!-- /.panel-body -->
